...
"""
df=pd.read_csv('datasets/rightPart.csv')
y_data=df['zone']
x_data=df.drop(['zone','rss7','rss5'],axis=1) #axis=1 because it is a column
...
"""  **************DATASET ATTRIBUTES ************
zone,rss0,rss1,rss2,rss3,rss4,rss5,rss6,rss7,magEarthY,magEarthZ
"""
...
#********************************* KNN ***********************************
KNNclf=neighbors.KNeighborsClassifier(n_neighbors=2) #n_neighbors=5 default
...
#********************************* Soft Voting ***********************************
#SoftVotingclf=VotingClassifier(estimators=[('dt',clf_en),('svm',svmclf),('mlp',mlpclf),('knn',KNNclf),('nb',NBclf)],voting='soft')
SoftVotingclf=VotingClassifier(estimators=[('dt',clf_gini),('svm',svmclf),('knn',KNNclf),('mlp',mlpclf),('nb',NBclf)],voting='soft')
...
labels=[1, 2,3,4,5]
target_names=['11','12','13','14','15']
modelDirectory='models/rightPart/'
